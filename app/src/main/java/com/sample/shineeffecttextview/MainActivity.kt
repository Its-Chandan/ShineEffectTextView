...
import com.app.shineeffecttextview.Shimmer
import com.app.shineeffecttextview.ShineEffectTextView


class MainActivity : AppCompatActivity() {

    lateinit var tv1: ShineEffectTextView
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tv2 = findViewById<ShineEffectTextView>(R.id.tv2)
        val tv3 = findViewById<ShineEffectTextView>(R.id.tv3)
        val tv4 = findViewById<ShineEffectTextView>(R.id.tv4)
